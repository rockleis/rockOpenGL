...
void Render() {
    ...
    //glPushMatrix glPopMatrix 记录当前的矩阵，pop出之前的矩阵状态
    glPushMatrix();
    glTranslatef(0.0f, 0.0f, -2.0f);
    glRotatef(-45.0f, 0.0f, 1.0f, 0.0f);
    glScalef(0.5f, 0.6f, 0.7f);
...
//    glRotatef(-45.0f, 0.0f, 1.0f, 0.0f);
//    glBegin(GL_TRIANGLES);
//    glVertex3f(0.0+0.5f, 0.0f, 0.0f);
//    glVertex3f(-0.5+0.5f, -0.5f, 0.0f);
//    glVertex3f(-0.0+0.5f, -0.5f, 0.0f);
//    glEnd();
